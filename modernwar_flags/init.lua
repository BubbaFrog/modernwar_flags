----------------------------------------------------------
-- Minetest :: modernwaric Flags Mod (modernwar_flags)
--
-- See README.txt for licensing and other information
-- Code adapted from "pride_flags" mod by Leslie E. Krause
-- Copyright (c) 2022, BubbaFrog
--
-- ./games/minetest_game/mods/modernwar_flags/init.lua
----------------------------------------------------------
...
local flag_list = {"ukraine", "russia", "israel", "nato", "un", "france", "germany", "palestine", "iraq", "uganda", "afghan", "mexico", "china"}
...
minetest.register_entity( "modernwar_flags:wavingflag", {
	initial_properties = {
		...
		pointable = false,
		mesh = "wavingflag.b3d",
		textures = { string.format( "modernwar_flags_%s.png", flag_list[1] ) },
...
print( cur_wind )
	...
	reset_texture = function ( self, flag_idx )
		...
		local texture = string.format( "modernwar_flags_%s.png", flag_list[ self.flag_idx ] )
